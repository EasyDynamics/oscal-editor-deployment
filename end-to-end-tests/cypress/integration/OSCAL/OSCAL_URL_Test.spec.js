describe('system-security-plans', () => {
  it('successfully loads ssps ', () => {
    ...
    cy.contains('OSCAL SSP URL').first().should('exist').next().click().clear().type("http://localhost:8080/oscal/v1/ssps/cff8385f-108e-40a5-8f7a-82f3dc0eaba8")
...
describe('component definitions', () => {
    it('successfully loads components ', () => {
      ...
      cy.contains('OSCAL Component URL').first().should('exist').next().click().clear().type("http://localhost:8080/oscal/v1/component-definitions/8223d65f-57a9-4689-8f06-2a975ae2ad72")
      cy.contains('Reload').click()
